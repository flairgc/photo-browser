...
export const Icon = ({
  ...
  <svg
    ...
    {...svgProps}
    style={{
      color: svgProps.color ?? 'currentColor',
      ...style,
    }}
  >
    {children}
...
type IconWrapProps = Omit<React.ComponentProps<typeof Icon>, 'children'>;

const getIconComponent = (svg: JSX.Element) => (props: IconWrapProps) => (
  <Icon {...props}>
    {svg}
  </Icon>
);
